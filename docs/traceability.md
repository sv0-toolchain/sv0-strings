...
- **209** covered by a `tests.tsv` row (85 rows total; SS-182 added
  ...
  `T-RELEASE-MANIFEST-SHAPE-001` → BACKEND-007 / GOV-002).
- **43** covered by a non-test verification marker in the requirement's own
